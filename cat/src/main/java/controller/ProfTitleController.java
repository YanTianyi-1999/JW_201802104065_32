...
public class ProfTitleController extends HttpServlet {
    ...
    /**
     * POST, http://106.54.82.57:8080/profTitle.ctl, 增加头衔
    ...
    /**
     * DELETE, http://106.54.82.57:8080/profTitle.ctl?id=1, 删除id=1的头衔
     * 
    ...
    /**
     * PUT, http://106.54.82.57:8080/profTitle.ctl, 修改头衔
     *
    ...
    /**
     * GET, http://106.54.82.57:8080/profTitle.ctl?id=1, 查询id=1的头衔
     * GET, http://106.54.82.57:8080/profTitle.ctl, 查询所有的头衔
     * 把一个或所有头衔对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
